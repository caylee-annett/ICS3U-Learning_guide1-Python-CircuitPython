        ...
        for alien_number in range(len(aliens)):
            if aliens[alien_number].x > 0:
                if stage.collide(aliens[alien_number].x + 1,
                    ...
                    # change Neopixels to red
                    pixel[0] = constants.RED
                    pixel[1] = constants.RED
                    pixel[2] = constants.RED
                    pixel[3] = constants.RED
                    pixel[4] = constants.RED
                    # alien hit the ship
                    sound.stop()
                    sound.play(crash_sound)
                    time.sleep(3.0)
                    # turn off Neopixels
                    pixel[0] = constants.OFF
                    pixel[1] = constants.OFF
                    pixel[2] = constants.OFF
                    pixel[3] = constants.OFF
                    pixel[4] = constants.OFF
...
def game_over_scene(final_score):
    ...
    # sets background image to 0 in the image bank
